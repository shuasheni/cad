...
class JointSet():
    def __init__(self, joint_file, load_bodies=True, new_joint=False, g1_id=None, g2_id=None):
        self.is_new_joint = new_joint
        ...
        print(self.body_one_obj_file)
        print(self.body_two_obj_file)
        if load_bodies:
