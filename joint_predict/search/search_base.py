...
class SearchBase:
    ...
    def load_cache(self, jps, prediction_limit):
        ...
        for prediction_index in self.pred_indices:
            ...
            # print(f"{prediction_index}: {self.pred_probs[prediction_index]}")
            ...
            _, a1 = jps.get_joint_prediction_axis(1, prediction_index)
            _, a2 = jps.get_joint_prediction_axis(2, prediction_index)

            # print(f"prediction_index:{prediction_index}")

            # is_symmetric1 = jps.is_joint_body_rotationally_symmetric(body=1, joint_axis_direction=a1)
            # is_symmetric2 = jps.is_joint_body_rotationally_symmetric(body=2, joint_axis_direction=a2)
            ...
            self.cache.append({
                ...
                "skip_rotation": False
                # "skip_rotation": is_symmetric1 or is_symmetric2,
            })
